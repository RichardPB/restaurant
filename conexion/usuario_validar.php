                        ...
                        if($fila[3]=="CLIENTE"){
                         ...
                         if($fila[3]=="MOZO"){
                                ...
                                $nombre = $fil3[1]." ".$fil3[2]." ".$fil3[3];
                                 ...
                                 $sql10 = "select * from empleado where IdPersona='$cliente' ";
                                $res10 = mysql_query($sql10,$cnn);
                                                              
                                $fil10 = mysql_fetch_array($res10);
                                   $_SESSION['idempleado'] = $fil10[0];
