...
if ($_SERVER["REQUEST_METHOD"] == "POST") {  
	...
	$cnn=conectar();
        ...
        $query = "select  Bebida_estado  FROM bebidas where id_bebidas = '$Bebida[0]' ";
	...
	$query1 = "UPDATE `bebidas` SET `Bebida_estado`='2' WHERE id_Bebidas = '$Bebida[$i]'";
	...
	$query2 = "UPDATE `bebidas` SET `Bebida_estado`='1' WHERE id_Bebidas = '$Bebida[$i]'";
