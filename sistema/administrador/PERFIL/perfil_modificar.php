<?php
	...
	$numero=$row[10];
	 ...
	 $combog = mysql_query("SELECT * FROM TIPODOCUMENTO WHERE ESTADO=1",$cnn);
         ...
         $query1 = "SELECT * from usuario where Id_persona=$idpersona";
...
<form id="form_persona_mod" name="form_perfil_mod" class="form-vertical">
	<div class="panel panel-warning">
		<div class="panel-heading">
			<span class="glyphicon glyphicon-glyphicon glyphicon-edit" aria-hidden="true">&nbsp;Editar Perfil</span> 
		</div>
		...
		<div class="panel-body">
			...
			<div class="input-group">
				...
				<input type="text" name="txttelefono" id="txttelefono" class="form-control" maxlength="15" value="<?php echo $telefono;  ?>" onkeypress="return soloNumeros(event)">
			</div>
			<br>
			<div class="input-group">
			...
			<div class="input-group">							 
				...
				<input type="text" name="txtdocumento" id="txtdocumento" class="form-control" value="<?php echo $numero;  ?>" onkeypress="return soloNumeros(event)" maxlength="12">
			...
			<div class="input-group">
				...
				<input type="password" name="txtcontrasena" id="txtcontrasena" class="form-control" value="<?php echo $clave;  ?>">
			</div>
			<br>
						
                        <button type="button" onclick="perfil_modificar('<?php echo $idpersona;?>');" class="btn btn-info" style="width:200px;"><span  aria-hidden="true" >&nbsp;Actualizar</span></button>
