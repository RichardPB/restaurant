    <div class="panel-body">
       	    <form id="form_mesa_list2" name="form_mesa_list2" action="carta/carta_actcan.php" method="post">
...
<script>
   ...
   function mostrarDatos(){
       load_div("subcontenido3","carta/carta_list_activar_1.php?q="+$("#txtbuscarBebidaCA").val());
   }
</script>