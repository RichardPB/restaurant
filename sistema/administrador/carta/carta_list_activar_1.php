...
header("Content-Type: text/html;charset=utf-8");
	...
	$cnn = conectar();
	$query = "select  * FROM v_carta where Nombre like '".$_GET['q']."%' and carta_estado=2 limit 5";
	
	$result = mysql_query($query, $cnn) or die("Error de conexion");
	$cantidad = is_resource($result) ? mysql_num_rows($result) : 0;
        
        
         $query1 = "select  * FROM v_carta1 where Nombre like '".$_GET['q']."%' and carta_estado=2 limit 5";
