<?php
	...
	$query = "select  * FROM V_empleado_cancelar where nombre like '".$_GET['q']."%'";
	  ...
	  <?php while ($row = mysql_fetch_array($result)) { ?>		
		  <tr >
				...
				<td><h5><?php echo $row[2]; ?></h5></td>
                                <td><Input type="checkbox" class="form-control input-sm"  NAME="empleado[]" value="<?php echo$row[0];?>"/></td>
