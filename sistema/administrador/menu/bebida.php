<?php
	...
	// echo"<script type=\"text/javascript\">alert('".$_GET['q']."');</script>" ;
         $query = "select  * FROM v_bebida where nombre like '".$_GET['q']."%' and estado='Activo' LIMIT 8 ";
	...
	<table class="table table-striped table-hover" align="center">	
	  ...
	  <?php while ($row = mysql_fetch_array($result)) { ?>		
		  <tr align="center">
				...
				<td><h5><a href='#' data-dismiss="modal" onclick="select(<?php echo $row[0]; ?>,'<?php echo $row[1]; ?>');"><?php echo $row[1]; ?></a></h5></td>   		
