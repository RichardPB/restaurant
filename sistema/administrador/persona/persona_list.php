    ...
    <div class="panel-body">
		...
		<div class="input-group">
		    ...
		    <input type="text" name="txtbuscarpersonaAC" id="txtbuscarpersonaAC" class="form-control" placeholder="Ingrese el nombre a buscar"onkeypress="return soloLetras(event)">
