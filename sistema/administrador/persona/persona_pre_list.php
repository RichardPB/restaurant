...
<br>
	...
	<div class="section">
        ...
        <div class="section">
		<a data-toggle="modal" data-target="#listarpersona" onclick="load_div('lista_persona', 'persona/persona_listar.php?q='+$('#txtbuscarpersona' ).val());" style="cursor:pointer"><img src="../../imagenes/LISTAR_USUARIO.jpg" alt="Img"></a>
	</div>
	<div class="section">
