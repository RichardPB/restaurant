    ...
    <div class="panel-body">
       	    <form id="form_TipoBebida_list1" name="form_Bebida_list1" action="plato/plato_actcan.php" method="post">
...
<script>
   ...
   function mostrarDatos(){
       load_div("subcontenido2","plato/plato_list_1.php?q="+$("#txtbuscarBebidaAC").val());
   }
</script>