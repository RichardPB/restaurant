		...
		<div class="panel-body">
			...
			<form id="form_usuario_list" name="form_usuario_list" action="usuario/usuario_cancelar.php" method="post">
				<div class="input-group">
					...
					<input type="text" name="txtbuscarusuario" id="txtbuscarusuario" class="form-control" placeholder="Ingrese el usuario a buscar" onkeypress="return soloLetras(event)">
...
<br>
	...
	<div class="section">
		<a onclick="load_div('sub1', 'usuario/usuario_list.php');" style="cursor:pointer"><img src="../../imagenes/CANCELAR.jpg" alt="Img"></a>
	</div>
        <div class="section">
		<a onclick="load_div('sub1', 'usuario/usuario_list_activar.php');" style="cursor:pointer"><img src="../../imagenes/ACTIVAR.jpg" alt="Img"></a>
	</div>
...
function mostrarDatos() {
	load_div("subcontenido", "usuario/usuario_listar_1.php?q="+$("#txtbuscarusuario" ).val());
}
</script>
