			...
			<div class="input-group">
				<span class="input-group-addon"><span class="glyphicon glyphicon-user" aria-hidden="true">&nbspEmpleado&nbsp;</span></span>
				 <input type="hidden"  name="txtidempleado" id="txtidempleado" class="form-control">
                                <input type="text"  style="width:290px" name="txtempleado" id="txtempleado" class="form-control" placeholder="Seleccione empleado" disabled="true">
			       <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#usuarioempleado"><span class="glyphicon glyphicon-search" aria-hidden="true">&nbsp;Seleccionar</span></button>
                       </div>
			<br>
