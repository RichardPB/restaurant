    ...
    <div class="panel-body">
       	    <form id="form_persona_list1" name="form_persona_list1" action="cliente/cliente_actcan.php" method="post">
...
<script>
   ...
   function mostrarDatos(){
       load_div("subcontenido2","cliente/cliente_list_1.php?q="+$("#txtbuscarpersonaAC").val());
   }
</script>