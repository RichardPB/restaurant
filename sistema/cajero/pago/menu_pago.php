...
<form id="form_pago_reg" name="form_pago_reg" class="form-vertical" >
	...
	<div class="panel-body">
			 ...
			 <span class="input-group-addon"><span class="glyphicon glyphicon-warning-sign" aria-hidden="true">&nbsp;Cantidad</span></span>
                   ...
                   &nbsp;
                    ...
                    <table class="table table-striped table-hover">	
                        ...
                        <?php $contador++; $total=$total+$row1[2];}} ?>
                             <?php
                            if($cantidad2>0){
			...
			<span class="input-group-addon"><span class="glyphicon glyphicon-list-alt" aria-hidden="true">&nbspMozo</span></span>
                     ...
                     <br>
                     <div class="input-group">
		        <span class="input-group-addon"><span class="glyphicon glyphicon-user" aria-hidden="true">&nbsp;Cliente&nbsp</span></span>
                       <input type="hidden"  name="txtidcliente" id="txtidcliente" class="form-control">
                     
                        <input type="text"  style="width:61%" name="txtcliente" id="txtcliente" class="form-control" placeholder="Seleccione Cliente" disabled="true">
			<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#listarpersona" ><span class="glyphicon glyphicon-search" aria-hidden="true">&nbsp;Cliente&nbsp;</span></button>
                     </div>
                    <br>
		    ...
		    <span class="input-group-addon"><span class="glyphicon glyphicon-hdd" aria-hidden="true">&nbsp;Mesa&nbsp</span></span>
                    ...
                    <input type="text"  name="txtmesa" id="txtmesa" class="form-control" value="<?php echo $row[1];?>" >
                     ...
                     <br>
                     <div class="input-group">							 
				<span class="input-group-addon"><span class="glyphicon glyphicon-file" aria-hidden="true">&nbsp;Comprobante&nbsp&nbsp&nbsp </span></span>
                                <select id="cbtppago" name="cbtppago" onclick="tp();" class="form-control" >
                      ...
                      <br>
                     <div class="input-group">
		    <span class="input-group-addon"><span class="glyphicon glyphicon-usd" aria-hidden="true">&nbsp;Importe Total&nbsp</span></span>
                 
                    <input type="text"  name="txttotal" id="txttotal" class="form-control" value="<?php echo $total;?>" >
		    </div>
        ...
        <footer>
            <button type="button" onclick="pago_reg(<?php echo $_GET['idcarta']; ?>);" class="btn btn-primary" ><span class="glyphicon glyphicon-usd" aria-hidden="true">&nbsp;&nbsp;&nbsp;&nbsp;Pagar&nbsp;&nbsp;&nbsp;&nbsp;</span></button>
...
function tp()
{
  ...
  var seleccion=document.form_pedido_reg.cbtppago;
 
  //alert(seleccion[1].value);
  
  if(seleccion.value=="Factura"){
     
       var total=document.form_pedido_reg.txttotal;
       var pagar=(parseFloat(total.value)*0.18)+parseFloat(total.value);
     
      document.form_pedido_reg.txttotal.value=pagar.toFixed(2);
  
  };
   document.form_pedido_reg.cbtppago.value="Seleccionar";
