<?php
	...
	$cnn = conectar();
	 $query = "select  * FROM v_carta1 where  carta_estado=1 ";
	$result = mysql_query($query, $cnn) or die("Error en la conexion");
       $cantidad = is_resource($result) ? mysql_num_rows($result) : 0;
	
 ?>
<form id="form_pedidobebida_reg" name="form_pedidobebida_reg" class="form-vertical" >
<div  class="panel panel-default">
    ...
    <div align="center">
    <button type="button" onclick="pedido_bebida_reg();" class="btn btn-primary" ><span class="glyphicon glyphicon-ok" aria-hidden="true">&nbsp;&nbsp;&nbsp;&nbsp;Guardar&nbsp;&nbsp;&nbsp;&nbsp;</span></button>
